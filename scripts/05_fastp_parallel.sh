...
#SBATCH --nodes=1
#SBATCH --ntasks=4 ## Change this
#SBATCH --cpus-per-task=1
#SBATCH --mem-per-cpu=1000
#SBATCH --error=05_fastp-parallel.err
#SBATCH --output=05_fastp-parallel.out
