...
License
- **Scripts and code**: Licensed under the [MIT License](/LICENSE). You are free to use, modify, and distribute the scripts with attribution.
- **Documentation (Markdown files)**: Licensed under [Creative Commons Attribution 4.0 International (CC BY 4.0)](/LICENSE-CC-BY-4.0.md). You are free to share and adapt the documentation with appropriate attribution.
